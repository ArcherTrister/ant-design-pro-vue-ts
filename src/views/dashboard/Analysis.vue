            ...
            <div>
              ...
              <div>
                <v-chart :force-fit="true" :height="405" :data="pieData" :scale="pieScale">
                  <v-tooltip :show-title="false" dataKey="item*percent" />
                  <v-axis />
...
export default class Analysis extends MixinDevice {
  // data
  private loading: boolean = true
  private rankList: any[] = []
  // 搜索用户数
  private searchUserData: any[] = []
  private searchUserScale: any
  private searchTableColumns: any
  private searchData: any[] = []
  private barData: any[] = []
  private barData2: any[] = []
  //
  private pieScale: any
  private pieData: any[] = []
