<template>
  <page-view title="单号：234231029431" logo="https://gw.alipayobjects.com/zos/rmsportal/nxkuOJlFJuAUhzlMTCEe.png">
    <detail-list slot="headerContent" size="small" :col="2" class="detail-layout">
      <detail-list-item term="创建人">
        曲丽丽
      </detail-list-item>
      <detail-list-item term="订购产品">
        XX服务
      </detail-list-item>
    ...
    <a-card style="margin-top: 24px" :bordered="false" title="用户信息">
      ...
      <a-card type="inner" title="多层信息组">
        <detail-list title="组名称" size="small">
          <detail-list-item term="负责人">
            林东东
          </detail-list-item>
          <detail-list-item term="角色码">
            1234567
          </detail-list-item>
...
import { DetailList, DetailListItem } from '@/components/tools/oldIndex'
...
export default class Advanced extends MixinDevice {
  // data
  private tabList: any[] = [
    {
      key: '1',
